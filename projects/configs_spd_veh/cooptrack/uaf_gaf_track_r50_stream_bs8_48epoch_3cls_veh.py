...
# Training settings (vehicle-only single-end)
...
# UACP: stage 1 (vehicle-only single-end training)
...
use_comm = False
h_ref = 25.0
training_stage = 1   # 1=vehicle-only
use_gru = False
...
data_root = "./datasets/V2X-Seq-SPD-Batch-65-10-10761/vehicle-side/"
info_root = "./data/infos/V2X-Seq-SPD-Batch-65-10-10761-forecasting/vehicle-side/"
